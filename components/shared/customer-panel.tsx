        ...
        <Box>
          <HStack className="items-center justify-between">
            ...
            {onClose ? (
              <Pressable
                onPress={onClose}
                className="flex h-8 w-8 items-center justify-center rounded-full border border-[var(--color-border)] bg-white hover:bg-[var(--color-background)]"
              >
                <X size={16} color="#6b7280" strokeWidth={2} />
              </Pressable>
            ) : null}
          </HStack>
          <Text className="mt-3 text-xl font-semibold text-[var(--color-neutral-900)]">
          ...
          {onOpenCustomer ? (
            <Button
              ...
              variant="outline"
              action="primary"
              className="mt-3 w-full rounded-full border-[var(--color-primary-600)] bg-transparent px-4 py-2"
          ...
          <Box>
            ...
            <VStack space="sm" className="mt-3">
              ...
              {visibleNotes.length === 0 ? (
                <Box className="rounded-2xl border border-transparent bg-[var(--color-background)] px-4 py-3">
                  <HStack className="items-center justify-between gap-3">
                    <Badge
                      size="sm"
                      action="muted"
                      className="rounded-full px-3 py-1 text-xs font-semibold bg-[rgba(22,163,74,0.18)] text-[#15803d]"
                    >
                  ...
                  <Text className="mt-2 text-sm font-semibold text-[var(--color-neutral-900)]">
                    Richiesta cuscini extra
                  </Text>
                  <Text className="mt-1 text-xs leading-5 text-[var(--color-neutral-600)]">
                    Il cliente ha richiesto due cuscini aggiuntivi per la camera. Da preparare prima del check-in.
                  </Text>
                  <HStack className="mt-3 flex-row flex-wrap gap-2">
                    <Badge
                      size="sm"
                      action="muted"
                      className="rounded-full px-3 py-1 text-xs font-semibold bg-[rgba(234,179,8,0.22)] text-[#92400e]"
                    >
